...
- **FAE**: Facultad de Administracion y Economía.
- **FAHU**: Facultad de Humanidades.
- **FING**: Facultad de Ingeniería.

## Lugares de Interés
- **ED**: Edificio Salas de Innovación Docente.
- **EAO**: Escuela de Artes y Oficios.
- **EPF**: Edificio Pabellón Forma.
- **Aula Magna**: Sala de conciertos ubicada en la EAO.
- **Casino Central**: Casino Oficial de la EAO.
- **Foro Griego**: Uno de los sectores más icónicos de la universidad.
- **Cenicero**: Sector de la Universidad para carretes.
- **Patio de los Naranjos**: Patio ubicado en la EAO.
...
<figure>
  <img src="https://admisioningenieriausach.cl/wp-content/uploads/2021/08/Nuevo-edifico-Facultad-de-Admisnistracion-y-Economia-FAE.png" alt="epf" width="600">
  <figcaption>Por sus siglas "Edificio Pabellón Forma" o también conocido como "Mall" o "Mayorista 10" es el edificio que está en la entrada a la Universidad por Estación Central. Principalmente, aquí tendrán ramos en donde ocuparán computadores ya que en las salas de clases están equipados con ellos.</figcaption>
</figure>

### Escuela de Artes y Oficios (EAO)
<figure>
  <img src="https://pbs.twimg.com/media/EyjSw4pWgAU1bcj.jpg:large" alt="eao" width="600">
...
<figure>
  ...
  <figcaption>El Aula Magna es una sala de conciertos ubicada en la EAO, donde generalmente se realizan conciertos, titulaciones y otras actividades.</figcaption>
</figure>
